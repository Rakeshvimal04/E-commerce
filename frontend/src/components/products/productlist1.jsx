...
function Productlist1() {
  ...
  return (
    <>
      <div>
        <h1 className="magiccolorbg text-center ">
          Experience the Magic of colors
        </h1>
        <div className="p-list1 d-flex">
          ...
          <img
            src={product12}
            alt="wall primer exterior"
            className="plist-img"
            onClick={() => handleImageClick(2)}
          />
          <img
            src={product13}
            alt="wall primer interior"
            className="plist-img"
      ...
      <div>
          ...
          <>
            <div className="productdetails text-center p-2  ">
              ...
              <h5 className=" text-center text-white m-3 ">
                WATER BASED POLYURETHANE WALL PRIMER <br />
          ...
          <>
            ...
            <div className="productdetails text-center p-2  ">
              ...
              <h5 className=" text-center text-white m-3 text-justify">
                ECONOMICAL WATER BASED WALL PRIMER PAINT
                <br />
                FOR INTERIORS
              </h5>
            </div>
        ...
        {selectedImage === 4 && (
          <div className="productdetails text-center p-2  ">
            ...
            <h5 className=" text-center text-white m-3 text-justify">
              2-in-1 WATER BASED ACRYLIC WALL PRIMER FOR <br />
              INTERIORS/EXTERIORS
            </h5>
          </div>
        )}
